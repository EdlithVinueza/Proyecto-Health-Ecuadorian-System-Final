...
/**
 * Pagar Cita por Transferencaa Paciente Controller
 
 */
@Controller
@RequestMapping("pacientes")
public class PagarCitaTransferencaaPacienteController {

    /**
     * Información de los session y url de formularios html
     */
    private final String TITULO_NAVBAR = "Pacientes";
    private final String NOMBRE_NAVBAR = "nombrePasoPaciente";
    private final String URL_MENU_PRINCIPAL = "/pacientes";
    private final String HTML_URL_FORMULARIO_COBRO_TRANSFERENCIA = "pacientes/formularios/pagar_orden_transferencia_formulario";
    ...
    /**
     * Metodo que permite verificar los datos de la orden de cobro
     * @param pagoTransferenciaTO
     * @param result
    ...
    /**
     * Metodo que permite confirmar el pago de la orden de cobro
     * @param pagoTransferenciaTO
     * @param result
     * @param redirectAttributes
     * @param modelo
