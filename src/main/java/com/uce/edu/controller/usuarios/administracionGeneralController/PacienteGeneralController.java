...
/**
 * Paciente General Controller
 * 
 */
@Controller
@RequestMapping("administracion-general")
public class PacienteGeneralController {
    ...
    private final String HTML_URL_LISTA_PACIENTES = "administracionGeneral/listas/paciente_lista";
    private final String HTML_URL_FORMULARIO_PACIENTE = "administracionGeneral/formularios/paciente_formulario";
