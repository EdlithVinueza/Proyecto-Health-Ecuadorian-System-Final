...
/**
 * Agendar Cita Secretaria Controller
 
 */
@Controller
@RequestMapping("administracion-secretaria")
public class AgendarCitaSecretariaController {
/**
 ...
 */
    ...
    /**
     * Url de formularios html
     */
    private final String HTML_URL_FORMULARIO_AGENDAR_CITA = "secretariaGeneral/formularios/agendar_cita_formulario";
    private final String HTML_URL_LISTA_BUSCAR_CITA = "secretariaGeneral/listas/buscar_cita_lista";
    ...
    /**
     * Metodo que permite buscar citas por especialidad, dia y hora
     * @param especialidad
     * @param diaCita
     * @param horaCita
     * @param modelo
    ...
    /**
     * Metodo que permite mostrar el formulario para agendar una cita
    ...
    /**
     * Metodo que permite guardar una cita en la agenda
    ...
    public String guardarCitaEnAgenda(
        ...
        if (usuarioActual == null || cedulaUsuarioActual == null) {
            ...
            /// -->> Aqui mandar nuevamente la lista de busquedas
    ...
    /**
     * Metodo que permite confirmar la cita
     * @param modelo
     * @param session
     * @return
     * @throws IOException
    ...
    public String confirmarAgendarCita(Model modelo, HttpSession session) throws IOException {
        ...
        modelo.addAttribute("cedulaPaciente", cedulaPaciente);
        modelo.addAttribute("cedulaAuditor", cedulaAuditor);
    ...
    /**
     * Metodo que permite generar un pdf de la orden de cobro
     * @param session
     * @return
     * @throws IOException
     */
