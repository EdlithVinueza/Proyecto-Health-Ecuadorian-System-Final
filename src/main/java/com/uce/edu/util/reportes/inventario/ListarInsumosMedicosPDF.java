...
/**
 * ListarInsumosMedicosPDF
 * 
 */
public class ListarInsumosMedicosPDF {
    /**
     * Método que permite generar un PDF con la lista de insumos médicos
     * 
     * @param listaInsumosMedicos
     * @return
     * @throws IOException
     */
    public ByteArrayOutputStream generatePdfInsumosMedicos(List<InsumoMedico> listaInsumosMedicos) throws IOException {
        ...
        try {
            ...
            Paragraph title = new Paragraph("Lista de Insumos Médicos", darkBlueFont);
            ...
            // especificados
            String[] headers = { "Código", "Nombre", "Proveedor", "Ruc Proveedor", "Descripción", "Precio Compra",
                    "Precio Venta", "Stock" };
            ...
            for (InsumoMedico insumoMedico : listaInsumosMedicos) {
                table.addCell(insumoMedico.getCodigo());
                table.addCell(insumoMedico.getNombre());
