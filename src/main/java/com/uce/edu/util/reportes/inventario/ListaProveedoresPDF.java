 ...
 * 
 */
public class ListaProveedoresPDF {
    /**
     * Método que permite generar un PDF con la lista de proveedores
     * 
     * @param listaProveedores
     * @return
     * @throws IOException
     */
    public ByteArrayOutputStream generarPdfProveedores(List<Proveedor> listaProveedores) throws IOException {
        ...
        try {
            ...
            Paragraph title = new Paragraph("Lista de Proveedores", darkBlueFont);
            ...
            // especificados
            String[] headers = { "RUC", "Nombre Empresa", "Dirección", "Teléfono", "Correo" };
            ...
            for (Proveedor proveedor : listaProveedores) {
                ...
                table.addCell(proveedor.getNombreEmpresa());
                table.addCell(proveedor.getDireccion());
                table.addCell(proveedor.getTelefono());
                table.addCell(proveedor.getCorreo());
            }
            // Agregar la tabla al documento
            document.add(table);
